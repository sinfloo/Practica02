...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-08-2020 a las 01:19:25
...
(1, '123', 'SISTEMAS', '988252459', '1', 'emp01');
...
(1, 'HAMBURGUESA', 3, 1000, '1'),
(2, 'PIERNA BROASTER', 6, 1000, '1'),
(3, 'ALITAS BROASTER', 5, 1000, '1');
...
--
ALTER TABLE `cliente`
  MODIFY `IdCliente` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `detalle_ventas`
--
ALTER TABLE `detalle_ventas`
  MODIFY `IdDetalleVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
...
--
ALTER TABLE `ventas`
  MODIFY `IdVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=143;
